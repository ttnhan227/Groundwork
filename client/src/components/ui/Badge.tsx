...
export type BadgeVariant =
  "human" | "agent" | "neutral" | "success" | "warning" | "danger" | "outline";
...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const variantClasses: Record<BadgeVariant, string> = {
    ...
    agent:
      "bg-[var(--ink-sepia-subtle)] text-[var(--ink-sepia)] border border-[var(--ink-sepia-border)] font-mono",
    neutral:
      "bg-[var(--paper-subtle)] text-[var(--ink-secondary)] border border-[var(--hairline)]",
    outline:
      "bg-transparent text-[var(--ink-secondary)] border border-[var(--hairline-strong)]",
    success:
