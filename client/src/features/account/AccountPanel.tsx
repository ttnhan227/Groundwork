  ...
  return (
    <label className="settings-toggle flex items-center justify-between py-2 cursor-pointer group min-w-0">
      <div className="min-w-0 flex-1 pr-4">
        ...
        <p className="text-[11px] text-[var(--ink-secondary)] font-sans break-words">{detail}</p>
      </div>
...
function Heading({
  ...
  return (
    <div className="border-b border-[var(--hairline)] pb-4 mb-6 min-w-0">
      ...
      <p className="text-xs text-[var(--ink-secondary)] mt-1 font-sans break-words">{detail}</p>
    </div>
  );
}
...
export function AccountPanel({
  ...
  const tabsList = useMemo<
    Array<{ id: AccountTab; label: string; detail: string; icon: ReactNode; admin?: boolean }>
  >(
    () => [
      {
        id: "profile",
        ...
        <header className="h-14 px-4 sm:px-6 border-b border-[var(--hairline)] bg-[var(--paper)] flex items-center justify-between flex-shrink-0 min-w-0">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] font-mono text-[var(--ink-muted)] truncate">{user.email}</p>
            </div>
          </div>
                    ...
                    >
                      <span
                        className={`flex-shrink-0 ${
                          isActive ? "text-[var(--ink-blue)]" : "text-[var(--ink-muted)] group-hover:text-[var(--ink)]"
                        }`}
                      >
                        {item.icon}
                      </span>
                      ...
                      <ChevronRight
                        ...
                        className={`flex-shrink-0 transition-transform ${
                          isActive ? "text-[var(--ink-blue)] translate-x-0.5" : "opacity-0 group-hover:opacity-40"
                        }`}
                      />
                    </button>
                  );
          ...
          <main className="flex-1 overflow-y-auto p-4 sm:p-8 bg-[var(--surface)] min-w-0 space-y-6">
            ...
            {tab === "profile" && (
              <div className="space-y-6 min-w-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 min-w-0">
                  <div className="p-4 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-[var(--ink-muted)] font-mono truncate">{user.email}</p>
                  ...
                  <div className="p-4 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] flex items-center justify-between gap-3 min-w-0">
                    <div className="flex items-center gap-2.5 min-w-0">
                      <CheckCircle2
                        size={18}
                        className={user.google_linked ? "text-[var(--success)]" : "text-[var(--ink-faint)]"}
                      />
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] text-[var(--ink-muted)]">
                          {user.google_linked ? "Connected for single sign-on" : "Not connected to account"}
                        </p>
                      </div>
                    </div>
                    <span
                ...
                >
                  <div>
                    <h3 className="font-serif text-sm font-bold text-[var(--ink)]">Personal Information</h3>
                    <p className="text-xs text-[var(--ink-muted)] mt-0.5">
                      This display name appears across shared research workspaces and deliverable revision history.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 min-w-0">
                    ...
                    <div>
                      ...
                      <Input value={user.email} disabled className="opacity-60 cursor-not-allowed font-mono text-xs" />
                    </div>
                  </div>

                  <div className="pt-2 flex justify-end">
                    <Button variant="human" size="sm" type="submit" disabled={busy}>
                      Save profile
                    </Button>
                  </div>
                </form>
                ...
                <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-4 min-w-0">
                  <div>
                    <h3 className="font-serif text-sm font-bold text-[var(--ink)]">Language & Interface Theme</h3>
                    <p className="text-xs text-[var(--ink-muted)] mt-0.5">
                      Choose your UI localization and switch between light and dark manuscript themes.
                    </p>
                  </div>
            ...
            {tab === "security" && (
              <div className="space-y-6 min-w-0">
                ...
                <form
                  ...
                  className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-4 min-w-0"
                >
                  <h3 className="font-serif text-sm font-bold text-[var(--ink)]">Change Password</h3>
                ...
                <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-4 min-w-0">
                  <div className="flex items-center justify-between min-w-0">
                    <div>
                      <h3 className="font-serif text-sm font-bold text-[var(--ink)]">Active Device Sessions</h3>
                      <p className="text-xs text-[var(--ink-muted)] mt-0.5">
                        Sessions are created when you sign in or refresh your secure access token.
                      </p>
                    </div>
                    ...
                    {sessions.length > 0 && (
                      <Button
                        ...
                        onClick={() =>
                          perform(async () => {
                            await api("/profile/sessions/revoke-all", token, { method: "POST" });
                            onSignOut();
                          })
                        }
                        className="flex-shrink-0"
                  ...
                  <div className="space-y-2 min-w-0">
                    {sessions.map((session, index) => (
                      ...
                      >
                        <div className="flex items-center gap-2.5 min-w-0">
                          <Shield size={16} className="text-[var(--ink-blue)] flex-shrink-0" />
                          <div className="min-w-0">
                            <strong className="block font-medium text-[var(--ink)] truncate">
                              {index === 0 ? "Current active session" : "Signed-in session"}
                            </strong>
                            <p className="text-[11px] font-mono text-[var(--ink-muted)] truncate">
                              Started {new Date(session.created_at).toLocaleString()} · Expires{" "}
                        ...
                        <Button
                          ...
                          onClick={() =>
                            perform(async () => {
                              await api(`/profile/sessions/${session.id}`, token, { method: "DELETE" });
            ...
            {tab === "defaults" && (
              <div className="space-y-6 min-w-0">
                ...
                <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-4 min-w-0">
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 min-w-0">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setPreferences({ ...preferences, document_language: e.target.value })
                        }
                        className="w-full h-9 px-3 text-xs rounded-[var(--radius-sm)] border border-[var(--hairline)] bg-[var(--surface)] text-[var(--ink)] focus:outline-none focus:border-[var(--ink-blue)] font-sans"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setPreferences({
                            ...preferences,
                            default_tone: e.target.value as UserPreferences["default_tone"],
                          })
                        }
                        className="w-full h-9 px-3 text-xs rounded-[var(--radius-sm)] border border-[var(--hairline)] bg-[var(--surface)] text-[var(--ink)] focus:outline-none focus:border-[var(--ink-blue)] font-sans"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setPreferences({
                            ...preferences,
                            citation_style: e.target.value as UserPreferences["citation_style"],
                          })
                        }
                        className="w-full h-9 px-3 text-xs rounded-[var(--radius-sm)] border border-[var(--hairline)] bg-[var(--surface)] text-[var(--ink)] focus:outline-none focus:border-[var(--ink-blue)] font-sans"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setPreferences({
                            ...preferences,
                            page_size: e.target.value as UserPreferences["page_size"],
                          })
                        }
                        className="w-full h-9 px-3 text-xs rounded-[var(--radius-sm)] border border-[var(--hairline)] bg-[var(--surface)] text-[var(--ink)] focus:outline-none focus:border-[var(--ink-blue)] font-sans"
                      >
                        ...
                        onChange={(e) =>
                          setPreferences({
                            ...
                            default_export_format:
                              e.target.value as UserPreferences["default_export_format"],
                          })
                        }
                        className="w-full h-9 px-3 text-xs rounded-[var(--radius-sm)] border border-[var(--hairline)] bg-[var(--surface)] text-[var(--ink)] focus:outline-none focus:border-[var(--ink-blue)] font-sans"
                      >
                  ...
                  <div className="pt-2 flex justify-end">
                    <Button variant="human" size="sm" onClick={savePreferences} disabled={busy}>
              ...
              <div className="space-y-6 min-w-0">
                ...
                <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-3 min-w-0">
                  <Toggle
                    ...
                    onChange={(v) => setPreferences({ ...preferences, notify_processing_completed: v })}
                  ...
                  <Toggle
                    ...
                    onChange={(v) => setPreferences({ ...preferences, notify_processing_failed: v })}
                  ...
                  <Toggle
                    ...
                    onChange={(v) => setPreferences({ ...preferences, notify_comments: v })}
                    title="Team comments"
                  ...
                  <Toggle
                    ...
                    onChange={(v) => setPreferences({ ...preferences, notify_reviews: v })}
              ...
              <div className="space-y-6 min-w-0">
                ...
                <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-4 min-w-0">
                  <Toggle
                    ...
                    onChange={(v) => setPreferences({ ...preferences, retain_activity_history: v })}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setPreferences({ ...preferences, retention_days: Number(e.target.value) })
                      }
                ...
                <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-4 min-w-0">
                  <h3 className="font-serif text-sm font-bold text-[var(--ink)]">Data Actions & Exports</h3>
                  ...
                  <div className="space-y-3 min-w-0">
                    <div className="p-3 rounded-[var(--radius-sm)] bg-[var(--surface)] border border-[var(--hairline)] flex items-center justify-between gap-3 text-xs min-w-0">
                      <div className="flex items-center gap-2.5 min-w-0">
                        <Database size={16} className="text-[var(--ink-blue)] flex-shrink-0" />
                        <div className="min-w-0">
                          <strong className="block font-medium text-[var(--ink)] truncate">
                            Download account data
                          </strong>
                          <p className="text-[11px] text-[var(--ink-muted)]">
                            Export your profile, preferences, workspace list, and usage summary as JSON.
                          </p>
                        </div>
                      </div>
                      <Button variant="secondary" size="xs" onClick={exportData} className="flex-shrink-0">
                        <Download size={11} />
                        <span>Download</span>
                      </Button>
                    </div>
                    ...
                    <div className="p-3 rounded-[var(--radius-sm)] bg-[var(--surface)] border border-[var(--hairline)] flex items-center justify-between gap-3 text-xs min-w-0">
                      <div className="flex items-center gap-2.5 min-w-0">
                        <Trash2 size={16} className="text-[var(--warning)] flex-shrink-0" />
                        <div className="min-w-0">
                          <strong className="block font-medium text-[var(--ink)] truncate">
                            Clear activity and AI history
                          </strong>
                          <p className="text-[11px] text-[var(--ink-muted)]">
                            Removes conversations, AI results, usage records, and authored notifications.
                          </p>
                        </div>
                      </div>
                      <Button
                        ...
                        size="xs"
                        onClick={() => {
                          const confirmation = window.prompt('Type "clear history" to continue');
                          if (confirmation) {
                            perform(
                              async () =>
                      ...
                      <div className="flex items-center gap-2.5 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[11px] text-[var(--danger)] opacity-80">
                            Permanently purges your account, workspaces, and stored files. This cannot be undone.
                          </p>
                        </div>
                      </div>
                      <Button
              ...
              <div className="space-y-6 min-w-0">
                ...
                {stats && (
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 min-w-0">
                    <div className="p-3 rounded-[var(--radius-sm)] bg-[var(--paper)] border border-[var(--hairline)] text-center min-w-0">
                      ...
                      <span className="text-[11px] text-[var(--ink-muted)]">Documents</span>
                    </div>
                    ...
                    <div className="p-3 rounded-[var(--radius-sm)] bg-[var(--paper)] border border-[var(--hairline)] text-center min-w-0">
                      ...
                      <span className="text-[11px] text-[var(--ink-muted)]">Pages indexed</span>
                    </div>
                    ...
                    <div className="p-3 rounded-[var(--radius-sm)] bg-[var(--paper)] border border-[var(--hairline)] text-center min-w-0">
                      ...
                      <span className="text-[11px] text-[var(--ink-muted)]">Generated files</span>
                    </div>

                    <div className="p-3 rounded-[var(--radius-sm)] bg-[var(--paper)] border border-[var(--hairline)] text-center min-w-0">
                      <strong
                        className={`block font-mono text-xl font-bold ${
                          stats.failed_jobs ? "text-[var(--danger)]" : "text-[var(--ink)]"
                        }`}
                      >
                        {stats.failed_jobs}
                      </strong>
                      <span className="text-[11px] text-[var(--ink-muted)]">Failed jobs</span>
                    </div>
                  </div>
                )}
                ...
                {usage && (
                  <>
                    <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-3 min-w-0">
                      <div className="flex items-center justify-between min-w-0">
                        <h3 className="font-serif text-sm font-bold text-[var(--ink)]">Storage Allocation</h3>
                      ...
                      <p className="text-[11px] font-mono text-[var(--ink-muted)]">{storagePercent}% used</p>
                    </section>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 min-w-0">
                      <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-3 min-w-0">
                        <h3 className="font-serif text-sm font-bold text-[var(--ink)]">AI Activity</h3>
                        <div className="p-2.5 rounded bg-[var(--surface)] border border-[var(--hairline)] font-mono text-xs">
                          ...
                          <span className="text-[var(--ink-muted)]">requests in the last 30 days</span>
                        </div>
                        ...
                        <div className="space-y-1.5 min-w-0">
                          ...
                          {!Object.keys(usage.ai_requests_by_feature).length && (
                            <p className="text-xs text-[var(--ink-muted)]">No AI activity yet.</p>
                          )}
                        </div>
                      </section>

                      <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-3 min-w-0">
                        <h3 className="font-serif text-sm font-bold text-[var(--ink)]">Background Tasks</h3>
                        <div className="space-y-1.5 min-w-0">
                          ...
                          {!Object.keys(usage.jobs_by_status).length && (
                            <p className="text-xs text-[var(--ink-muted)]">No jobs active.</p>
                          )}
                        </div>
                      </section>
                    </div>
            ...
            {tab === "team" && (
              <div className="space-y-6 min-w-0">
                ...
                <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-4 min-w-0">
                  ...
                  {editableTeam && (
                    <form onSubmit={inviteMember} className="space-y-3 pt-2 border-t border-[var(--hairline-subtle)] min-w-0">
                ...
                <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-4 min-w-0">
                  <div className="flex items-center justify-between min-w-0">
                    <h3 className="font-serif text-sm font-bold text-[var(--ink)]">Workspace Members</h3>
                          ...
                          {member.role === "owner" || !editableTeam ? (
                            ...
                            <>
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  if (
                                    window.confirm(`Remove ${member.display_name} from this workspace?`)
                                  ) {
                                    perform(async () => {
                                      await api(
                                        `/workspaces/${workspaceId}/members/${member.id}`,
            ...
            {tab === "admin" && user.role === "admin" && (
              <div className="space-y-6 min-w-0">
                ...
                <section className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--paper)] border border-[var(--hairline)] space-y-4 admin-users min-w-0">
                  <div className="flex items-center justify-between min-w-0">
                    <h3 className="font-serif text-sm font-bold text-[var(--ink)]">All Registered Users</h3>
                    <span className="text-xs font-mono text-[var(--ink-muted)]">
                      ...
                      >
                        <div className="flex items-center gap-2.5 min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-[11px] font-mono text-[var(--ink-muted)] truncate">
                              {item.email} · {item.document_count} docs · {item.ai_requests} AI requests
                            </p>
                          </div>
                        </div>
                          ...
                          onClick={() =>
                            perform(async () => {
                              ...
                              setAdmins((current) =>
                                current.map((value) =>
                                  value.id === item.id
                                    ? { ...value, is_active: updated.is_active }
                                    : value,
                                ),
                              );
