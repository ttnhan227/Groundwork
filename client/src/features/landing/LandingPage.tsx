...
export function LandingPage({
  ...
  const [simulatorState, setSimulatorState] = useState<"blocked" | "resolved">(
    "blocked",
  );
  ...
  return (
    <main className="min-h-screen w-full bg-[var(--paper)] text-[var(--ink)] flex flex-col select-none overflow-x-hidden">
      ...
      <header className="h-14 border-b border-[var(--hairline)] bg-[var(--surface)] px-4 sm:px-6 flex items-center justify-between w-full min-w-0 z-20">
        <a
          href="/"
          className="flex items-center gap-2 text-decoration-none min-w-0 flex-shrink-0"
        >
          <BrandMark size={20} />
        ...
        <nav className="flex items-center gap-3 sm:gap-6 text-xs text-[var(--ink-secondary)] font-medium min-w-0">
          ...
          <a
            href="#insights"
            className="hidden sm:inline hover:text-[var(--ink)] text-[var(--ink-blue)] font-semibold transition-colors"
          >
            Research & Insights
          </a>
        ...
        <div className="max-w-3xl space-y-4 sm:space-y-6 min-w-0 w-full">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-[var(--radius-full)] bg-[var(--ink-blue-subtle)] border border-[var(--ink-blue-border)] text-xs text-[var(--ink-blue)] font-mono font-medium max-w-full truncate">
            ...
            <span className="truncate">
              Deterministic Deliverable Verification
            </span>
          </div>
          ...
          <h1 className="font-serif text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight text-[var(--ink)] leading-[1.18] break-words overflow-wrap-anywhere max-w-full">
            ...
            <span className="text-[var(--ink-blue)] block sm:inline">
              Groundwork audits every claim before you ship.
            </span>
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-[var(--ink-secondary)] leading-relaxed font-sans max-w-2xl break-words">
            Bring scattered RFPs, specifications, and client documents into a
            calm manuscript canvas. The agent drafts sections with monospace
            suggestions, automated verification flags unsupported SLA numbers in
            the margin, and the export gate guarantees 100% evidence-grounded
            deliverables.
          </p>
          ...
          <div className="flex items-center justify-between px-4 sm:px-6 py-3 bg-[var(--paper-subtle)] border-b border-[var(--hairline)] text-xs">
            ...
            <div className="flex items-center gap-3 text-[11px] font-mono text-[var(--ink-muted)]">
              <span className="hidden sm:inline">
                SEC 10-K &amp; DoD RFP Extraction
              </span>
              <span className="text-[var(--success)] font-semibold">
                0.0% Hallucination Gate
              </span>
            </div>
          </div>
            ...
            <div className="lg:col-span-7 relative min-h-[300px] sm:min-h-[360px] bg-slate-950 overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white">
                ...
                <p className="text-sm font-semibold leading-snug text-slate-100">
                  Cross-auditing generated proposal drafts against
                  multi-thousand page regulatory filings
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-2.5 text-xs">
                  ...
                  <div className="p-3 rounded-[var(--radius-sm)] border border-[var(--hairline)] bg-[var(--paper-subtle)] space-y-1">
                    <div className="flex items-center justify-between">
                      <strong className="text-[var(--ink)]">
                        DoD Logistics RFP Spec v3.1
                      </strong>
                      <span className="text-[10px] font-mono font-bold text-[var(--ink-blue)]">
                        4 Citations Active
                      </span>
                    </div>
                    <p className="text-[11px] text-[var(--ink-secondary)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 divide-y md:divide-y-0 md:divide-x divide-[var(--hairline)] w-full min-w-0">
            ...
            <div className="md:col-span-6 p-4 sm:p-6 space-y-4 bg-[var(--surface)] min-w-0">
              ...
              <p className="text-xs text-[var(--ink)] leading-relaxed font-sans break-words">
                Apex Horizon requires zero-trust replication and automated
                regional failover across multi-region active clusters.
              </p>
              ...
              {simulatorState === "blocked" ? (
                <div className="p-3 sm:p-3.5 rounded bg-[var(--warning-bg)] border border-[var(--warning-border)] space-y-2 min-w-0">
                  <p className="text-xs font-mono text-[var(--ink)] break-words">
                    "The modernized cloud infrastructure guarantees{" "}
                    <strong>99.999% uptime</strong> with under 10-second
                    failover."
                  </p>
                  <div className="text-[11px] text-[var(--warning)] flex items-start gap-1.5 font-semibold">
                    <AlertTriangle size={13} className="flex-shrink-0 mt-0.5" />
                    <span className="break-words">
                      Unsupported SLA: Security spec specifies 99.99%
                      availability (p. 4).
                    </span>
                  </div>
                  <Button
                ...
                <div className="p-3 sm:p-3.5 rounded bg-[var(--ink-sepia-subtle)] border border-[var(--ink-sepia-border)] space-y-2 ink-dried min-w-0">
                  <p className="text-xs font-sans text-[var(--ink)] break-words">
                    "The modernized cloud infrastructure guarantees{" "}
                    <strong>99.99% high availability</strong> with sub-minute
                    automated failover."
                  </p>
              ...
              <p className="text-xs text-[var(--ink-secondary)] leading-relaxed font-sans break-words">
                Automated snapshot replication guarantees Recovery Point
                Objective (RPO) &lt; 1 min and Recovery Time Objective (RTO)
                &lt; 15 min. [Source: Benchmark-Report.pdf, p. 1]
              </p>
            </div>
      ...
      <section className="border-y border-[var(--hairline)] bg-[var(--surface)] py-4 px-4 sm:px-6 select-none w-full">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-xs text-[var(--ink-secondary)] font-medium">
          ...
          <span className="hidden sm:inline text-[var(--hairline-strong)]">
            ·
          </span>
          <span className="flex items-center gap-1.5">
            <LockKeyhole
          ...
          <span className="flex items-center gap-1.5">
            <ShieldCheck
              ...
              className="text-[var(--success)] flex-shrink-0"
            />{" "}
            Continuous deterministic audit gate
          </span>
          <span className="hidden sm:inline text-[var(--hairline-strong)]">
            ·
          </span>
          <span className="flex items-center gap-1.5">
            <Download
              ...
              className="text-[var(--ink-sepia)] flex-shrink-0"
            />{" "}
            Clean exports with provenance appendix
          </span>
        </div>
      </section>
      ...
      <section
        id="workflow"
        className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-20 space-y-8 sm:space-y-12 w-full min-w-0"
      >
        <div className="text-center space-y-2 max-w-2xl mx-auto min-w-0">
          ...
          <p className="text-sm text-[var(--ink-secondary)] font-sans break-words">
            Replace hallucinated AI text with an evidence-grounded deliverable
            loop.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full min-w-0">
          <div className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--surface)] border border-[var(--hairline)] space-y-2 min-w-0">
            <span className="text-[10px] font-mono text-[var(--ink-faint)] font-bold">
              01
            </span>
            <div className="w-8 h-8 rounded bg-[var(--ink-blue-subtle)] text-[var(--ink-blue)] flex items-center justify-center">
              <Upload size={16} />
            </div>
            <h3 className="font-serif text-sm font-bold text-[var(--ink)] break-words">
              Ingest Sources
            </h3>
            <p className="text-xs text-[var(--ink-secondary)] leading-relaxed break-words">
              Upload RFPs, specs, and notes. Page structure, tables, and
              geometry are indexed.
            </p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--surface)] border border-[var(--hairline)] space-y-2 min-w-0">
            ...
            <p className="text-xs text-[var(--ink-secondary)] leading-relaxed break-words">
              Monospace streaming proposals draft sections with direct citation
              anchors.
            </p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--surface)] border border-[var(--hairline)] space-y-2 min-w-0">
            ...
            <p className="text-xs text-[var(--ink-secondary)] leading-relaxed break-words">
              Unsupported claims surface in the margin with 1-click verified SLA
              resolutions.
            </p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-[var(--radius-md)] bg-[var(--surface)] border border-[var(--hairline)] space-y-2 min-w-0">
            ...
            <p className="text-xs text-[var(--ink-secondary)] leading-relaxed break-words">
              Ship PDF, Word, or Markdown with attached cryptographic provenance
              appendix.
            </p>
          </div>
        </div>
      ...
      <section
        id="insights"
        className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-20 space-y-8 sm:space-y-12 w-full min-w-0 border-t border-[var(--hairline)]"
      >
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 min-w-0">
          <div className="space-y-2 max-w-2xl min-w-0">
            ...
            <p className="text-sm text-[var(--ink-secondary)] font-sans break-words">
              Technical whitepapers, compliance mapping frameworks, and
              benchmark evaluations from the Groundwork engineering team.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full min-w-0">
          ...
          <article className="p-5 sm:p-6 rounded-[var(--radius-lg)] bg-[var(--surface)] border border-[var(--hairline)] hover:border-[var(--ink-blue-border)] shadow-[var(--shadow-subtle)] space-y-4 flex flex-col justify-between transition-all group">
            <div className="space-y-3">
              ...
              <h3 className="font-serif text-lg font-bold text-[var(--ink)] group-hover:text-[var(--ink-blue)] transition-colors">
                Zero Phantom Citations: Eliminating Hallucinated Page Numbers in
                SEC 10-K Proposal Workflows
              </h3>
              <p className="text-xs text-[var(--ink-secondary)] leading-relaxed font-sans">
                Comparative analysis of deterministic page-geometry verification
                against standard cosine-similarity RAG across 1,200 financial
                and cybersecurity disclosure filings.
              </p>
            </div>
            ...
            <div className="pt-3 border-t border-[var(--hairline)] flex items-center justify-between text-xs">
              <div className="flex items-center gap-3 font-mono text-[11px]">
                <span className="text-[var(--ink-muted)]">
                  Hallucinations:{" "}
                  <strong className="text-[var(--success)]">0.0%</strong>
                </span>
                <span className="text-[var(--ink-muted)]">
                  Baseline RAG:{" "}
                  <strong className="text-[var(--warning)]">18.4%</strong>
                </span>
              </div>
          ...
          <article className="p-5 sm:p-6 rounded-[var(--radius-lg)] bg-[var(--surface)] border border-[var(--hairline)] hover:border-[var(--ink-blue-border)] shadow-[var(--shadow-subtle)] space-y-4 flex flex-col justify-between transition-all group">
            <div className="space-y-3">
              ...
              <h3 className="font-serif text-lg font-bold text-[var(--ink)] group-hover:text-[var(--ink-blue)] transition-colors">
                Automating NIST AI RMF 1.0 &amp; ISO/IEC 42001 Regulatory
                Mapping for Enterprise RFPs
              </h3>
              <p className="text-xs text-[var(--ink-secondary)] leading-relaxed font-sans">
                A formal guide to converting high-stakes government and defense
                RFP criteria into strict deterministic evidence verification
                gates with cryptographic provenance.
              </p>
            </div>
            ...
            <div className="pt-3 border-t border-[var(--hairline)] flex items-center justify-between text-xs">
              <div className="flex items-center gap-3 font-mono text-[11px]">
                <span className="text-[var(--ink-muted)]">
                  Traceability:{" "}
                  <strong className="text-[var(--ink)]">100% Matrix</strong>
                </span>
                <span className="text-[var(--ink-muted)]">
                  Export Gate:{" "}
                  <strong className="text-[var(--success)]">Enforced</strong>
                </span>
              </div>
              <span className="inline-flex items-center gap-1 font-semibold text-[var(--ink-blue)]">
          ...
          <article className="p-5 sm:p-6 rounded-[var(--radius-lg)] bg-[var(--surface)] border border-[var(--hairline)] hover:border-[var(--ink-blue-border)] shadow-[var(--shadow-subtle)] space-y-4 flex flex-col justify-between transition-all group">
            <div className="space-y-3">
              ...
              <h3 className="font-serif text-lg font-bold text-[var(--ink)] group-hover:text-[var(--ink-blue)] transition-colors">
                Asynchronous Task Queues &amp; pgvector: Multi-Tenant Isolation
                with Celery and Redis
              </h3>
              <p className="text-xs text-[var(--ink-secondary)] leading-relaxed font-sans">
                Deep dive into building non-blocking PDF OCR extraction
                pipelines with task revocation, chunk-level tenant boundaries,
                and HNSW cosine indexing.
              </p>
            </div>
            ...
            <div className="pt-3 border-t border-[var(--hairline)] flex items-center justify-between text-xs">
              <div className="flex items-center gap-3 font-mono text-[11px]">
                <span className="text-[var(--ink-muted)]">
                  Query Latency:{" "}
                  <strong className="text-[var(--success)]">&lt; 38ms</strong>
                </span>
                <span className="text-[var(--ink-muted)]">
                  Pytest Coverage:{" "}
                  <strong className="text-[var(--ink)]">102 tests</strong>
                </span>
              </div>
              <span className="inline-flex items-center gap-1 font-semibold text-[var(--ink-blue)]">
          ...
          <article className="p-5 sm:p-6 rounded-[var(--radius-lg)] bg-[var(--surface)] border border-[var(--hairline)] hover:border-[var(--ink-blue-border)] shadow-[var(--shadow-subtle)] space-y-4 flex flex-col justify-between transition-all group">
            <div className="space-y-3">
              ...
              <h3 className="font-serif text-lg font-bold text-[var(--ink)] group-hover:text-[var(--ink-blue)] transition-colors">
                Deterministic Verification vs. Probabilistic LLMs in Legal,
                Medical &amp; Defense Deliverables
              </h3>
              <p className="text-xs text-[var(--ink-secondary)] leading-relaxed font-sans">
                How aerospace and healthcare contractors audit mission-critical
                deliverables against FDA and DoD specifications prior to
      ...
      <footer
        id="security"
        className="border-t border-[var(--hairline)] bg-[var(--surface)] py-8 px-4 sm:px-6 mt-auto w-full"
      >
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[var(--ink-muted)]">
          <div className="flex items-center gap-2">
            <BrandMark size={16} />
            <span className="font-serif font-bold text-[var(--ink)]">
              Groundwork
            </span>
          ...
          <p className="text-center sm:text-right">
            Verification-gated document intelligence. Draft, audit, and ship
